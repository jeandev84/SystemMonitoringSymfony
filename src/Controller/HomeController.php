...
class HomeController extends AbstractController
{
   ...
   */
    ...
    */
     ...
     * @return Response
     */
    public function index(WebsiteRepository $websiteRepository, StatusRepository $statusRepository)
    {
        $websites = $websiteRepository->findAll();
        $count = count($websites); /* dd($count); */
     ...
     * @throws \Exception
     */
    public function analyse(WebsiteRepository $websiteRepository, EntityManagerInterface $entityManager)
    {
       // Recuperer tous nos sites
       $websites = $websiteRepository->findAll();

       // Recuperer le status actuel de chacun
        foreach ($websites as $key => $site)
        {
            ...
            // Creer une nouvelle entite Status et l'enregistrer
            $status = new Status();
            $status->setCode($code)
        ...
        $this->addFlash('success', 'Le diagnostic a bien ete effectue.');


        // Se rediriger vers vers notre route "home"
        return $this->redirectToRoute('home');
    ...
    /**
     * @Route("/websites/{id}", name="website.show")
